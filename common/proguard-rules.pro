...
#自己不想混淆的配置,com.enovira.common下的不被混淆
-keep class com.enovira.common.**{*;}
#配置com.enovira.common下的变量和函数不被混淆
-keep class com.enovira.common.**{
    public <fields>;
    public <methods>;
}
#使com.enovira.common.view下的全部不被混淆
#-keep class com.enovira.common.view.**{*;}
